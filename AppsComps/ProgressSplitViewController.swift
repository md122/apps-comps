...
//            splitViewController?.presentsWithGesture = true
    ...
    override func viewWillAppear(_ animated: Bool) {
        self.navigationController?.setToolbarHidden(true, animated: false)
        //self.detailViewController.navigationItem.rightBarButtonItem = segmentBarItem
        let logoutButton: UIBarButtonItem = UIBarButtonItem(title: "Log Out", style: .plain, target: self, action: #selector(self.logoutClicked(_:)))
        logoutButton.tintColor = .red
        
//        self.detailViewController.toolbarItems = [logoutButton]
//        self.detailViewController.navigationController?.setToolbarItems(toolbarItems, animated: false)
    }
